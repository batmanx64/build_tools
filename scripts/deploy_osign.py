...
# -*- coding: utf-8 -*-
"""
deploy_osign.py - Office Sign 部署脚本
=======================================
功能：将 Office Sign（数字签名工具）的构建产物按平台部署到 out/<platform>/<branding>/osign 目录。
支持 iOS Framework 和 Android 多 ABI 聚合。
"""
